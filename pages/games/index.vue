<template>
  <view class="page games-list-page">
    <view class="floating-stars"></view>

    <view class="center-area container">
      <text class="title">游戏训练</text>
